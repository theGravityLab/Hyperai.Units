namespace Hyperai.Units
{
    public struct Channel
    {
        ...
        {
            return new() {UserId = userId, GroupId = groupId};
        }
        ...
        {
            return new() {UserId = null, GroupId = group};
        }

        public static Channel CreateMatchingUser(long user)
        {
            return new() {UserId = user, GroupId = null};
        }
        ...
        {
            return $"{(UserId != null ? UserId.ToString() : "null")}@{(GroupId != null ? GroupId.ToString() : "null")}"
                .GetHashCode();
        }
    }
}